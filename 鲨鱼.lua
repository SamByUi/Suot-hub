...
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "鲨鱼脚本"; Text ="载入中"; Duration = 2; })wait(3)

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "鲨鱼脚本"; Text ="加载50%"; Duration = 2; })wait(2)

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "鲨鱼脚本"; Text ="80%"; Duration = 2; })wait(3)

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "鲨鱼脚本"; Text ="载入成功"; Duration = 5; })
...
about:Label("小鲨鱼制作")
about:Label("每星期天星期六不一定更新")
about:Label("此脚本是测试的有bug告诉小鲨鱼")
about:Label("感谢游玩")
...
about:Button("艹屄脚本",function()
loadstring(game:HttpGet("https://pastebin.com/raw/bzmhRgKL"))();
end)

about:Button("操屄脚本", function()
...
about:Button("国外音乐脚本",function()          
 loadstring(game:HttpGet(('https://pastebin.com/raw/g97RafnE'),true))()                   
   ...
   about:Button("男娘(针对小鲨鱼)必听",function() 
         local sound = Instance.new("Sound") 
...
about:Button("变成真理", function()
workspace.Remote.TeamEvent:FireServer("Bright blue");
end)

about:Button("变成蹲大牢的", function()
...
SGV_Tab:Toggle("白天","开关",false,function()
    if not _G.FullBrightExecuted then
        ...
        _G.NormalLightingSettings "无限备弹 死亡后会卡无限子弹 需手动打几发子弹然后切换一下枪",function()
    local mods = {
		FanFire = true, 
		prepTime = 0, 
		equipTime = 0, 
